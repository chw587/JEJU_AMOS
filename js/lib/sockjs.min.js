    ...
    return function i(s, a, l) {
            ...
            e.exports = function(l, t) {
                ...
                l.bootstrap_iframe = function() {
                    ...
                    r.attachEvent("message", function(e) {
                        if (e.source === parent && (void 0 === u && (u = e.origin),
                        e.origin === u)) {
                            var n;
                            try {
                                n = h.parse(e.data)
        ...
        12: [function(t, e, n) {
            ...
            d._getReceiver = function(t, e, n) {
                return n.sameOrigin ? new f(e,l) : a.enabled ? new f(e,a) : s.enabled && n.sameScheme ? new f(e,s) : c.enabled() ? new c(t,e) : new f(e,u)
            }
            ,
        ...
        14: [function(_, E, t) {
            (function(i) {
                "use strict";
                _("./shims");
                var r, l = _("url-parse"), t = _("inherits"), s = _("json3"), u = _("./utils/random"), e = _("./utils/escape"), c = _("./utils/url"), a = _("./utils/event"), n = _("./utils/transport"), o = _("./utils/object"), f = _("./utils/browser"), h = _("./utils/log"), d = _("./event/event"), p = _("./event/eventtarget"), m = _("./location"), v = _("./event/close"), b = _("./event/trans-message"), y = _("./info-receiver"), g = function() {};
                function w(t, e, n) {
                    ...
                    if ("https:" === m.protocol && !i && !c.isLoopbackAddr(o.hostname))
        ...
        15: [function(t, e, n) {
            ...
            s.split = function(t, e) {
                ...
                var r, o, i, s, a = [], l = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.extended ? "x" : "") + (t.sticky ? "y" : ""), u = 0;
                for (t = new RegExp(t.source,l + "g"),
                n += "",
                _ || (r = new RegExp("^" + t.source + "$(?!\\s)",l)),
                e = void 0 === e ? -1 >>> 0 : function(t) {
                    return t >>> 0
                }(e); (o = t.exec(n)) && !(u < (i = o.index + o[0].length) && (a.push(n.slice(u, o.index)),
                ...
                return u === n.length ? !s && t.test("") || a.push("") : a.push(n.slice(u)),
            ...
            (function(t) {
                ...
                c.prototype._start = function(t, e, n, r) {
                    ...
                    try {
                        ...
                        return u("exception", t),
                        this.emit("finish", 0, ""),
                        void this._cleanup(!1)
                    }
                    if (r && r.noCredentials || !c.supportsCORS || (u("withCredentials"),
                    ...
                    this.xhr.onreadystatechange = function() {
                        if (o.xhr) {
                            var t, e, n = o.xhr;
                            switch (u("readyState", n.readyState),
                            n.readyState) {
                            case 3:
                                try {
                                    e = n.status,
                ...
                !c.enabled && n in t && (u("overriding xmlhttprequest"),
            ...
            (function(i) {
                ...
                c.prototype._createScript = function(t) {
                    ...
                    r.onreadystatechange = function() {
                        if (u("onreadystatechange", r.readyState),
        ...
        33: [function(t, e, n) {
            (function(s) {
                "use strict";
                var a, l, u = t("../../utils/random"), c = t("../../utils/url"), f = function() {};
            ...
            (function(f) {
                ...
                p.exports = {
                    ...
                    createHtmlfile: function(t, e) {
                        ...
                        u.open(),
                        u.write('<html><script>document.domain="' + f.document.domain + '";<\/script></html>'),
                        u.close(),
                        u.parentWindow[p.exports.WPrefix] = f[p.exports.WPrefix];
                        var c = u.createElement("div");
                        return u.body.appendChild(c),
            ...
            (function(s) {
                (function() {
                    var J = {
                      ...
                      , e = t && J[typeof a] && a && !a.nodeType && "object" == typeof s && s;
                    function F(t, l) {
                        t = t || B.Object(),
                        l = l || B.Object();
                        var u = t.Number || B.Number
                          ...
                          , d = t.Math || B.Math
                          , r = t.JSON || B.JSON;
                        "object" == typeof r && r && (l.stringify = r.stringify,
                        l.parse = r.parse);
                        var y, o = e.prototype, g = o.toString, a = o.hasOwnProperty;
                        function w(t, e) {
                            try {
                                t()
                            } catch (t) {
                        ...
                        function f(t) {
                            ...
                            if ("bug-string-char-index" == t)
                                ...
                                e = f("json-stringify") && f("date-serialization") && f("json-parse");
                            else if ("date-serialization" == t) {
                                if (e = f("json-stringify") && p) {
                                    var n = l.stringify;
                                    w(function() {
                                        e = '"-271821-04-20T00:00:00.000Z"' == n(new v(-864e13)) && '"+275760-09-13T00:00:00.000Z"' == n(new v(864e13)) && '"-000001-01-01T00:00:00.000Z"' == n(new v(-621987552e5)) && '"1969-12-31T23:59:59.999Z"' == n(new v(-1))
                                    })
                                }
                            } else {
                                ...
                                if ("json-parse" == t) {
                                    ...
                                    "function" == typeof a && w(function() {
                                        0 !== a("0") || a(!1) || (r = a(o),
                                        (s = 5 == r.a.length && 1 === r.a[0]) && (w(function() {
                                            s = !a('"\t"')
                                        }),
                                        s && w(function() {
                                            s = 1 !== a("01")
                        ...
                        f["bug-string-char-index"] = f["date-serialization"] = f.json = f["json-stringify"] = f["json-parse"] = null,
                        !f("json")) {
                            var h = "[object Function]"
                              ...
                              , j = function(t, e) {
                                ...
                                return n = s = null,
                                (j = o ? function(t, e) {
                                    var n, r, o = g.call(t) == h;
                                    for (n in t)
                                        o && "prototype" == n || !a.call(t, n) || (r = "constructor" === n) || e(n);
                                ...
                                function(t, e) {
                                    var n, r, o = g.call(t) == h, i = !o && "function" != typeof t.constructor && J[typeof t.hasOwnProperty] && t.hasOwnProperty || a;
                                    for (n in t)
                                ...
                                var i = {
                                  ...
                                  , T = function(t) {
                                    ...
                                    if (p)
                                        ...
                                        function c(t, e) {
                                            return h[e] + 365 * (t - 1970) + f((t - 1969 + (e = +(1 < e))) / 4) - f((t - 1901 + e) / 100) + f((t - 1601 + e) / 400)
                                        }
                                        var f = d.floor
                                          , h = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334];
                                        e = function(t) {
                                            for (o = f(t / 864e5),
                                            n = f(o / 365.2425) + 1970 - 1; c(n + 1, 0) <= o; n++)
                                                ;
                                            for (r = f((o - c(n, 0)) / 30.42); c(n, r + 1) <= o; r++)
                                                ;
                                            o = 1 + o - c(n, r),
                                            s = f((i = (t % 864e5 + 864e5) % 864e5) / 36e5) % 24,
                                            a = f(i / 6e4) % 60,
                                            l = f(i / 1e3) % 60,
                                            u = i % 1e3
                                        }
                                    ...
                                    return (T = function(t) {
                                        return -1 / 0 < t && t < 1 / 0 ? (e(t),
                                        t = (n <= 0 || 1e4 <= n ? (n < 0 ? "-" : "+") + S(6, n < 0 ? -n : n) : S(4, n)) + "-" + S(2, r + 1) + "-" + S(2, o) + "T" + S(2, s) + ":" + S(2, a) + ":" + S(2, l) + "." + S(3, u) + "Z",
                                        n = r = o = s = a = l = u = null) : t = null,
                                        t
                                    }
                                    )(t)
                                };
                                if (f("json-stringify") && !f("date-serialization")) {
                                    ...
                                    var N = /[\x00-\x1f\x22\x5c]/g
                                      , k = function(t, e, n, r, o, i, s) {
                                        ...
                                        "object" == typeof a && a && (a.getUTCFullYear && "[object Date]" == g.call(a) && a.toJSON === v.prototype.toJSON ? a = T(a) : "function" == typeof a.toJSON && (a = a.toJSON(t))),
                                        n && (a = n.call(e, t, a)),
                                        a == y)
                                            return a === y ? a : "null";
                                        switch ("object" == (l = typeof a) && (u = g.call(a)),
                                        u || l) {
                                        case "boolean":
                                        case "[object Boolean]":
                                            return "" + a;
                                        ...
                                        if (J[typeof e] && e)
                                            if ((s = g.call(e)) == h)
                                                ...
                                                for (var a, l = 0, u = e.length; l < u; )
                                                    a = e[l++],
                                                    "[object String]" != (s = g.call(a)) && "[object Number]" != s || (i[a] = 1)
                                            }
                                        if (n)
                                            if ((s = g.call(n)) == x) {
                                                if (0 < (n -= n % 1))
                            ...
                            if (!f("json-parse")) {
                                ...
                                function L() {
                                    for (var t, e, n, r, o, i = U, s = i.length; R < s; )
                                        ...
                                        case 58:
                                        case 44:
                                            return t = m ? i.charAt(R) : i[R],
                                            R++,
                                            t;
                                        case 34:
                                            for (t = "@",
                                            R++; R < s; )
                                                if ((o = i.charCodeAt(R)) < 32)
                                                    I();
                                                else if (92 == o)
                                                    switch (o = i.charCodeAt(++R)) {
                                                    case 92:
                                                    ...
                                                    case 117:
                                                        for (e = ++R,
                                                        n = R + 4; R < n; R++)
                                                            48 <= (o = i.charCodeAt(R)) && o <= 57 || 97 <= o && o <= 102 || 65 <= o && o <= 70 || I();
                                                        t += M("0x" + i.slice(e, R));
                                                        break;
                                                    default:
                                                        I()
                                        ...
                                        default:
                                            ...
                                            o = i.charCodeAt(++R)),
                                            48 <= o && o <= 57) {
                                                for (48 == o && (48 <= (o = i.charCodeAt(R + 1)) && o <= 57) && I(),
                                                r = !1; R < s && (48 <= (o = i.charCodeAt(R)) && o <= 57); R++)
                                                    ;
                                                ...
                                                if (101 == (o = i.charCodeAt(R)) || 69 == o) {
                                                    for (43 != (o = i.charCodeAt(++R)) && 45 != o || R++,
                                                    n = R; n < s && !((o = i.charCodeAt(n)) < 48 || 57 < o); n++)
                                                        ;
                                                    n == R && I(),
                                                    R = n
                                                }
                                ...
                                var R, U, M = c.fromCharCode, q = {
                                    ...
                                    "string" == typeof t) {
                                        ...
                                        if ("{" == t) {
                                            for (e = {}; "}" != (t = L()); )
                                                n ? "," == t ? "}" == (t = L()) && I() : I() : n = !0,
                                                "," != t && "string" == typeof t && "@" == (m ? t.charAt(0) : t[0]) && ":" == L() || I(),
                                                e[t.slice(1)] = D(L());
                                            return e
                                        }
                                        I()
                        ...
                        return l.runInContext = F,
                        l
                    }
                    if (!e || e.global !== e && e.window !== e && e.self !== e || (B = e),
                    t)
                        F(B, t);
                    else {
                        var n = B.JSON
        ...
        58: [function(t, n, e) {
            (function(i) {
                ...
                var d = t("requires-port")
                  ...
                  , l = /^([a-z][a-z0-9.+-]*:)?(\/\/)?([\\/]+)?([\S\s]*)/i
                  , m = /^[a-zA-Z]:/
                  , e = new RegExp("^[\\x09\\x0A\\x0B\\x0C\\x0D\\x20\\xA0\\u1680\\u180E\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200A\\u202F\\u205F\\u3000\\u2028\\u2029\\uFEFF]+");
                function v(t) {
                    return (t || "").toString().replace(e, "")
                }
                var b = [["#", "hash"], ["?", "query"], function(t, e) {
                ...
                function y(t) {
                    var e, n = ("undefined" != typeof window ? window : void 0 !== i ? i : "undefined" != typeof self ? self : {}).location || {}, r = {}, o = typeof (t = t || n);
                    if ("blob:" === t.protocol)
                        r = new x(unescape(t.pathname),{});
                    else if ("string" == o)
                        for (e in r = new x(t,{}),
                        a)
                            delete r[e];
                ...
                function w(t, e) {
                    t = v(t),
                    e = e || {};
                    var n, r = l.exec(t), o = r[1] ? r[1].toLowerCase() : "", i = !!r[2], s = !!r[3], a = 0;
                    return i ? a = s ? (n = r[2] + r[3] + r[4],
                    r[2].length + r[3].length) : (n = r[2] + r[4],
                    r[2].length) : s ? (n = r[3] + r[4],
                    a = r[3].length) : n = r[4],
                    "file:" === o ? 2 <= a && (n = n.slice(2)) : g(o) ? n = r[4] : o ? i && (n = n.slice(2)) : 2 <= a && g(e.protocol) && (n = r[4]),
                    {
                        protocol: o,
                        slashes: i || g(o),
                        slashesCount: a,
                ...
                function x(t, e, n) {
                    ...
                    !(this instanceof x))
                        return new x(t,e,n);
                    var r, o, i, s, a, l, u = b.slice(), c = typeof e, f = this, h = 0;
                    for ("object" != c && "string" != c && (n = e,
                    e = null),
                    ...
                    t = o.rest,
                    ("file:" === o.protocol && (2 !== o.slashesCount || m.test(t)) || !o.slashes && (o.protocol || o.slashesCount < 2 || !g(f.protocol))) && (u[3] = [/(.*)/, "pathname"]); h < u.length; h++)
                        "function" != typeof (s = u[h]) ? (i = s[0],
                        l = s[1],
                        ...
                        t = t.slice(0, a.index)),
                        f[l] = f[l] || r && s[3] && e[l] || "",
                        s[4] && (f[l] = f[l].toLowerCase())) : t = s(t, f);
                    n && (f.query = n(f.query)),
                    ...
                    "/" !== f.pathname.charAt(0) && g(f.protocol) && (f.pathname = "/" + f.pathname),
                    ...
                    f.username = s[0] || "",
                    f.password = s[1] || ""),
                    f.origin = "file:" !== f.protocol && g(f.protocol) && f.host ? f.protocol + "//" + f.host : "null",
                    f.href = f.toString()
                }
                x.prototype = {
                    set: function(t, e, n) {
                        ...
                        return r.origin = "file:" !== r.protocol && g(r.protocol) && r.host ? r.protocol + "//" + r.host : "null",
                        r.href = r.toString(),
                        r
                    },
                    toString: function(t) {
