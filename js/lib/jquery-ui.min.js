...
!function(t) {
    ...
    _.widget = function(t, i, e) {
        var s, o, n, r = {}, a = t.split(".")[0], l = a + "-" + (t = t.split(".")[1]);
        return e || (e = i,
        i = _.Widget),
        Array.isArray(e) && (e = _.extend.apply(null, [{}].concat(e))),
        _.expr.pseudos[l.toLowerCase()] = function(t) {
            return !!_.data(t, l)
        }
        ,
        _[a] = _[a] || {},
        s = _[a][t],
        o = _[a][t] = function(t, e) {
        ...
        (n = new i).options = _.widget.extend({}, n.options),
        ...
        s ? (_.each(s._childConstructors, function(t, e) {
            var i = e.prototype;
            _.widget(i.namespace + "." + i.widgetName, o, e._proto)
        }),
    ...
    _.widget.extend = function(t) {
        for (var e, i, s = a.call(arguments, 1), o = 0, n = s.length; o < n; o++)
            for (e in s[o])
                i = s[o][e],
                r.call(s[o], e) && void 0 !== i && (_.isPlainObject(i) ? t[e] = _.isPlainObject(t[e]) ? _.widget.extend({}, t[e], i) : _.widget.extend({}, i) : t[e] = i);
        return t
    }
    ,
    _.widget.bridge = function(n, e) {
        ...
        _.fn[n] = function(i) {
            ...
            return t ? this.length || "instance" !== i ? this.each(function() {
                ...
                !1) : e ? "function" != typeof e[i] || "_" === i.charAt(0) ? _.error("no such method '" + i + "' for " + n + " widget instance") : (t = e[i].apply(e, s)) !== e && void 0 !== t ? (o = t && t.jquery ? o.pushStack(t.get()) : t,
                !1) : void 0 : _.error("cannot call methods on " + n + " prior to initialization; attempted to call method '" + i + "'")
            }) : o = void 0 : (s.length && (i = _.widget.extend.apply(null, [i].concat(s))),
            this.each(function() {
                var t = _.data(this, r);
                t ? (t.option(i || {}),
                t._init && t._init()) : _.data(this, r, new e(i,this))
            })),
            o
        }
    }
    ...
    _.Widget.prototype = {
        ...
        _createWidget: function(t, e) {
            e = _(e || this.defaultElement || this)[0],
            this.element = _(e),
            this.uuid = i++,
            ...
            e !== this && (_.data(e, this.widgetFullName, this),
            this._on(!0, this.element, {
                remove: function(t) {
                    t.target === e && this.destroy()
                }
            }),
            this.document = _(e.style ? e.ownerDocument : e.document || e),
            this.window = _(this.document[0].defaultView || this.document[0].parentWindow)),
            this.options = _.widget.extend({}, this.options, this._getCreateOptions(), t),
            this._create(),
        ...
        destroy: function() {
            var i = this;
            this._destroy(),
            _.each(this.classesElementLookup, function(t, e) {
                i._removeClass(e, t)
            }),
        ...
        option: function(t, e) {
            ...
            if (0 === arguments.length)
                return _.widget.extend({}, this.options);
            if ("string" == typeof t)
                if (n = {},
                t = (i = t.split(".")).shift(),
                i.length) {
                    for (s = n[t] = _.widget.extend({}, this.options[t]),
                    o = 0; o < i.length - 1; o++)
                        s[i[o]] = s[i[o]] || {},
                        s = s[i[o]];
                    if (t = i.pop(),
        ...
        _setOptionClasses: function(t) {
            ...
            for (e in t)
                ...
                t[e] !== this.options.classes[e] && s && s.length && (i = _(s.get()),
        ...
        _classes: function(o) {
            ...
            function t(t, e) {
                for (var i, s = 0; s < t.length; s++)
                    i = r.classesElementLookup[t[s]] || _(),
                    i = o.add ? (function() {
                        var i = [];
                    ...
                    _(_.uniqueSort(i.get().concat(o.element.get())))) : _(i.not(o.element).get()),
        ...
        _untrackClassesElement: function(i) {
            var s = this;
            _.each(s.classesElementLookup, function(t, e) {
                -1 !== _.inArray(i.target, e) && (s.classesElementLookup[t] = _(e.not(i.target).get()))
            }),
        ...
        _on: function(o, n, t) {
            ...
            _.each(t, function(t, e) {
                function i() {
                    if (o || !0 !== a.options.disabled && !_(this).hasClass("ui-state-disabled"))
        ...
        _off: function(t, e) {
            ...
            t.off(e),
            this.bindings = _(this.bindings.not(t).get()),
            this.focusable = _(this.focusable.not(t).get()),
            this.hoverable = _(this.hoverable.not(t).get())
        },
        _delay: function(t, e) {
            var i = this;
        ...
        _trigger: function(t, e, i) {
            ...
            if (i = i || {},
            (e = _.Event(e)).type = (t === this.widgetEventPrefix ? t : this.widgetEventPrefix + t).toLowerCase(),
    ...
    _.each({
        ...
        _.Widget.prototype["_" + n] = function(e, t, i) {
            ...
            s && _.effects && _.effects.effect[o] ? e[n](t) : o !== n && e[o] ? e[o](t.duration, t.easing, i) : e.queue(function(t) {
                _(this)[n](),
                i && i.call(e[0]),
                t()
            })
    ...
    _.widget("ui.mouse", {
        ...
        _mouseInit: function() {
            ...
            this.element.on("mousedown." + this.widgetName, function(t) {
                ...
                if (!0 === _.data(t.target, e.widgetName + ".preventClickEvent"))
                    return _.removeData(t.target, e.widgetName + ".preventClickEvent"),
        ...
        _mouseDown: function(t) {
            if (!n) {
                ...
                var e = this
                  , i = 1 === t.which
                  , s = !("string" != typeof this.options.cancel || !t.target.nodeName) && _(t.target).closest(this.options.cancel).length;
                ...
                !0) : (!0 === _.data(t.target, this.widgetName + ".preventClickEvent") && _.removeData(t.target, this.widgetName + ".preventClickEvent"),
        ...
        _mouseMove: function(t) {
            if (this._mouseMoved) {
                if (_.ui.ie && (!document.documentMode || document.documentMode < 9) && !t.button)
        ...
        _mouseUp: function(t) {
            ...
            t.target === this._mouseDownEvent.target && _.data(t.target, this.widgetName + ".preventClickEvent", !0),
            this._mouseStop(t)),
    ...
    _.widget("ui.draggable", _.ui.mouse, {
        ...
        _mouseCapture: function(t) {
            var e = this.options;
            return !(this.helper || e.disabled || 0 < _(t.target).closest(".ui-resizable-handle").length) && (this.handle = this._getHandle(t),
        ...
        _mouseStart: function(t) {
            ...
            _.ui.ddmanager && (_.ui.ddmanager.current = this),
            this._cacheMargins(),
            ...
            _.ui.ddmanager && !e.dropBehaviour && _.ui.ddmanager.prepareOffsets(this, t),
            this._mouseDrag(t, !0),
            _.ui.ddmanager && _.ui.ddmanager.dragStart(this, t),
            !0)
        },
        ...
        _mouseDrag: function(t, e) {
            ...
            !e) {
                ...
                if (!1 === this._trigger("drag", t, e))
                    return this._mouseUp(new _.Event("mouseup",t)),
                    !1;
                this.position = e.position
            }
            return this.helper[0].style.left = this.position.left + "px",
            this.helper[0].style.top = this.position.top + "px",
            _.ui.ddmanager && _.ui.ddmanager.drag(this, t),
            !1
        },
        _mouseStop: function(t) {
            var e = this
              , i = !1;
            return _.ui.ddmanager && !this.options.dropBehaviour && (i = _.ui.ddmanager.drop(this, t)),
            this.dropped && (i = this.dropped,
            this.dropped = !1),
            "invalid" === this.options.revert && !i || "valid" === this.options.revert && i || !0 === this.options.revert || "function" == typeof this.options.revert && this.options.revert.call(this.element, i) ? _(this.helper).animate(this.originalPosition, parseInt(this.options.revertDuration, 10), function() {
        ...
        _mouseUp: function(t) {
            ...
            _.ui.ddmanager && _.ui.ddmanager.dragStop(this, t),
            this.handleElement.is(t.target) && this.element.trigger("focus"),
            _.ui.mouse.prototype._mouseUp.call(this, t)
        },
        cancel: function() {
        ...
        _createHelper: function(t) {
            var e = this.options
              ...
              , t = i ? _(e.helper.apply(this.element[0], [t])) : "clone" === e.helper ? this.element.clone().removeAttr("id") : this.element;
        ...
        _getParentOffset: function() {
            var t = this.offsetParent.offset()
              , e = this.document[0];
            return "absolute" === this.cssPosition && this.scrollParent[0] !== e && _.contains(this.scrollParent[0], this.offsetParent[0]) && (t.left += this.scrollParent.scrollLeft(),
        ...
        _setContainment: function() {
            ...
            (i = (e = _(s.containment))[0]) && (t = /(scroll|auto)/.test(e.css("overflow")),
        ...
        _trigger: function(t, e, i) {
            ...
            _.ui.plugin.call(this, t, [e, i, this], !0),
            /^(drag|start|stop)/.test(t) && (this.positionAbs = this._convertPositionTo("absolute"),
            i.offset = this.positionAbs),
            _.Widget.prototype._trigger.call(this, t, e, i)
        },
        plugins: {},
        _uiHash: function() {
            return {
    ...
    _.ui.plugin.add("draggable", "connectToSortable", {
        start: function(e, t, i) {
            ...
            i.sortables = [],
            _(i.options.connectToSortable).each(function() {
        ...
        drag: function(i, s, o) {
            _.each(o.sortables, function() {
                ...
                _.each(o.sortables, function() {
                    ...
                    t = this !== e && this._intersectsWith(this.containerCache) && _.contains(e.element[0], this.element[0]) ? !1 : t
                })),
    ...
    _.ui.plugin.add("draggable", "cursor", {
        ...
        stop: function(t, e, i) {
            i = i.options;
            i._cursor && _("body").css("cursor", i._cursor)
        }
    }),
    _.ui.plugin.add("draggable", "opacity", {
        ...
        stop: function(t, e, i) {
            i = i.options;
            i._opacity && _(e.helper).css("opacity", i._opacity)
        }
    }),
    _.ui.plugin.add("draggable", "scroll", {
        ...
        drag: function(t, e, i) {
            ...
            s.axis && "y" === s.axis || (t.pageX - _(r).scrollLeft() < s.scrollSensitivity ? o = _(r).scrollLeft(_(r).scrollLeft() - s.scrollSpeed) : _(window).width() - (t.pageX - _(r).scrollLeft()) < s.scrollSensitivity && (o = _(r).scrollLeft(_(r).scrollLeft() + s.scrollSpeed)))),
            !1 !== o && _.ui.ddmanager && !s.dropBehaviour && _.ui.ddmanager.prepareOffsets(i, t)
        }
    }),
    _.ui.plugin.add("draggable", "snap", {
        start: function(t, e, i) {
            var s = i.options;
            i.snapElements = [],
            _(s.snap.constructor !== String ? s.snap.items || ":data(ui-draggable)" : s.snap).each(function() {
                var t = _(this)
                  , e = t.offset();
        ...
        drag: function(t, e, i) {
            for (var s, o, n, r, a, l, c, f, h, p = i.options, u = p.snapTolerance, d = e.offset.left, g = d + i.helperProportions.width, m = e.offset.top, v = m + i.helperProportions.height, b = i.snapElements.length - 1; 0 <= b; b--)
                l = (a = i.snapElements[b].left - i.margins.left) + i.snapElements[b].width,
                f = (c = i.snapElements[b].top - i.margins.top) + i.snapElements[b].height,
                g < a - u || l + u < d || v < c - u || f + u < m || !_.contains(i.snapElements[b].item.ownerDocument, i.snapElements[b].item) ? (i.snapElements[b].snapping && i.options.snap.release && i.options.snap.release.call(i.element, t, _.extend(i._uiHash(), {
                    snapItem: i.snapElements[b].item
                })),
                i.snapElements[b].snapping = !1) : ("inner" !== p.snapMode && (s = Math.abs(c - v) <= u,
                o = Math.abs(f - m) <= u,
                n = Math.abs(a - g) <= u,
                r = Math.abs(l - d) <= u,
                ...
                h = s || o || n || r,
                "outer" !== p.snapMode && (s = Math.abs(c - m) <= u,
                o = Math.abs(f - v) <= u,
                n = Math.abs(a - d) <= u,
                r = Math.abs(l - g) <= u,
                s && (e.position.top = i._convertPositionTo("relative", {
                ...
                !i.snapElements[b].snapping && (s || o || n || r || h) && i.options.snap.snap && i.options.snap.snap.call(i.element, t, _.extend(i._uiHash(), {
                    snapItem: i.snapElements[b].item
                })),
                i.snapElements[b].snapping = s || o || n || r || h)
        }
    }),
    _.ui.plugin.add("draggable", "stack", {
        start: function(t, e, i) {
            var s, i = i.options, i = _.makeArray(_(i.stack)).sort(function(t, e) {
                return (parseInt(_(t).css("zIndex"), 10) || 0) - (parseInt(_(e).css("zIndex"), 10) || 0)
            });
            i.length && (s = parseInt(_(i[0]).css("zIndex"), 10) || 0,
            _(i).each(function(t) {
                _(this).css("zIndex", s + t)
            }),
    ...
    _.ui.plugin.add("draggable", "zIndex", {
        ...
        stop: function(t, e, i) {
            i = i.options;
            i._zIndex && _(e.helper).css("zIndex", i._zIndex)
        }
    });
    _.ui.draggable;
    var l = _
      ...
      , f = l.Color = function(t, e, i, s) {
        return new l.Color.fn.parse(t,e,i,s)
    }
      , h = {
        rgba: {
            props: {
      ...
      , g = l.each;
    function m(t) {
        return null == t ? t + "" : "object" == typeof t ? s[e.call(t)] || "object" : typeof t
    }
    function v(t, e, i) {
        var s = p[e.type] || {};
    ...
    function b(s) {
        ...
        n.length ? ("0,0,0,0" === n.join() && l.extend(n, E.transparent),
        o) : E[s]
    }
    function y(t, e, i) {
    ...
    u.rgba = -1 < d.style.backgroundColor.indexOf("rgba"),
    g(h, function(t, e) {
        e.cache = "_" + t,
        e.props.alpha = {
            idx: 3,
    ...
    (f.fn = l.extend(f.prototype, {
        parse: function(o, t, e, i) {
            ...
            s = "array"),
            "string" === s ? this.parse(b(o) || E._default) : "array" === s ? (g(h.rgba.props, function(t, e) {
                r[e.idx] = v(o[e.idx], e)
            }),
            this) : "object" === s ? (g(h, o instanceof f ? function(t, e) {
            ...
            : function(t, i) {
                ...
                n[s] && l.inArray(null, n[s].slice(0, 3)) < 0 && (null == n[s][3] && (n[s][3] = 1),
        ...
        is: function(t) {
            var o = f(t)
              , n = !0
              , r = this;
            return g(h, function(t, e) {
                var i, s = o[e.cache];
                return s && (i = r[e.cache] || e.to && e.to(r._rgba) || [],
        ...
        transition: function(t, r) {
            var e = (c = f(t))._space()
              , i = h[e]
              , t = 0 === this.alpha() ? f("transparent") : this
              , a = t[i.cache] || i.to(t._rgba)
              , l = a.slice()
              , c = c[i.cache];
            return g(i.props, function(t, e) {
                var i = e.idx
                  , s = a[i]
                  , o = c[i]
                  , n = p[e.type] || {};
    ...
    g(h, function(l, t) {
        var e = t.props
          ...
          , a = t.from;
        f.fn[l] = function(t) {
            if (r && !this[n] && (this[n] = r(this._rgba)),
            void 0 === t)
                return this[n].slice();
            var i = m(t)
        ...
        g(e, function(r, a) {
            f.fn[r] || (f.fn[r] = function(t) {
                var e, i = m(t), s = "alpha" === r ? this._hsla ? "hsla" : "rgba" : l, o = this[s](), n = o[a.idx];
                return "undefined" === i ? n : ("function" === i && (i = m(t = t.call(this, n))),
                null == t && a.empty ? this : ("string" === i && (e = c.exec(t)) && (t = n + parseFloat(e[2]) * ("+" === e[1] ? 1 : -1)),
                o[a.idx] = t,
                this[s](o)))
            }
            )
    ...
    (f.hook = function(t) {
        ...
        g(t, function(t, n) {
            ...
            l.fx.step[n] = function(t) {
                t.colorInit || (t.start = f(t.elem, n),
                t.end = f(t.end),
                t.colorInit = !0),
                l.cssHooks[n].set(t.elem, t.start.transition(t.end, t.pos))
            }
        })
    }
    ...
    var w, x, C, P, k, T, S, H, M, D, E = l.Color.names = {
        aqua: "#00ffff",
        black: "#000000",
        blue: "#0000ff",
        fuchsia: "#ff00ff",
        ...
        _default: "#ffffff"
    }, N = "ui-effects-", I = "ui-effects-style", W = "ui-effects-animated";
    function O(t) {
    ...
    function L(t, e, i, s) {
        ...
        i = null,
        e = {}),
        "number" != typeof e && !_.fx.speeds[e] || (s = i,
        i = e,
        e = {}),
    ...
    _.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], function(t, e) {
        _.fx.step[e] = function(t) {
            ("none" !== t.end && !t.setAttr || 1 === t.pos && !t.setAttr) && (l.style(t.elem, e, t.end),
            t.setAttr = !0)
        }
    }),
    ...
    _.effects.animateClass = function(o, t, e, i) {
        var n = _.speed(t, e, i);
        return this.queue(function() {
            ...
            e = e.map(function() {
                ...
                this.diff = function(t, e) {
                    ...
                    for (i in e)
                        s = e[i],
                        t[i] !== s && (k[i] || !_.fx.step[i] && isNaN(parseFloat(s)) || (o[i] = s));
                    return o
                }(this.start, this.end),
                this
            }),
            ...
            _.when.apply(_, e.get()).done(function() {
                s(),
    ...
    _.fn.extend({
        ...
        removeClass: (x = _.fn.removeClass,
        function(t, e, i, s) {
        ...
        toggleClass: (w = _.fn.toggleClass,
        function(t, e, i, s, o) {
            return "boolean" == typeof e || void 0 === e ? i ? _.effects.animateClass.call(this, e ? {
                add: t
            } : {
                remove: t
            }, i, s, o) : w.apply(this, arguments) : _.effects.animateClass.call(this, {
                toggle: t
            }, e, i, s)
        }
        ),
    ...
    _.expr && _.expr.pseudos && _.expr.pseudos.animated && (_.expr.pseudos.animated = (T = _.expr.pseudos.animated,
    function(t) {
        return !!_(t).data(W) || T(t)
    }
    )),
    !1 !== _.uiBackCompat && _.extend(_.effects, {
        ...
        createWrapper: function(i) {
            ...
            return i.wrap(t),
            i[0] !== o && !_.contains(i[0], o) || _(o).trigger("focus"),
            t = i.parent(),
        ...
        removeWrapper: function(t) {
            ...
            t[0] !== e && !_.contains(t[0], e) || _(e).trigger("focus")),
            t
        }
    }),
    _.extend(_.effects, {
        ...
        define: function(t, e, i) {
            return i || (i = e,
            e = "effect"),
            _.effects.effect[t] = i,
            _.effects.effect[t].mode = e,
            i
        },
        ...
        createPlaceholder: function(t) {
            ...
            e = _("<" + t[0].nodeName + ">").insertAfter(t).css({
        ...
        cleanUp: function(t) {
            _.effects.restoreStyle(t),
            _.effects.removePlaceholder(t)
        },
    ...
    _.fn.extend({
        effect: function() {
            function t(t) {
                var e = _(this)
                  , i = _.effects.mode(e, a) || n;
                e.data(W, !0),
                l.push(i),
                n && ("show" === i || i === n && "hide" === i) && e.show(),
                n && "none" === i || _.effects.saveStyle(e),
                "function" == typeof t && t()
            }
            var s = L.apply(this, arguments)
              , o = _.effects.effect[s.effect]
              , n = o.mode
              , e = s.queue
              , i = e || "fx"
              , r = s.complete
              , a = s.mode
              , l = [];
            return _.fx.off || !o ? a ? this[a](s.duration, r) : this.each(function() {
                r && r.call(this)
            ...
            function c(t) {
                ...
                s.mode = l.shift(),
                !1 === _.uiBackCompat || n ? "none" === s.mode ? (e[a](),
    ...
    _.fx.step.clip = function(t) {
        t.clipInit || (t.start = _(t.elem).cssClip(),
        "string" == typeof t.end && (t.end = B(t.end, t.elem)),
        t.clipInit = !0),
        _(t.elem).cssClip({
    ...
    ,
    D = {},
    _.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], function(e, t) {
        D[t] = function(t) {
    ...
    _.each(D, function(t, e) {
        _.easing["easeIn" + t] = e,
        _.easing["easeOut" + t] = function(t) {
            return 1 - e(1 - t)
        }
        ,
    ...
    d = _.effects,
    _.effects.define("blind", "hide", function(t, e) {
        var i = {
            up: ["bottom", "top"],
            vertical: ["bottom", "top"],
            down: ["top", "bottom"],
          ...
          , a = _.effects.createPlaceholder(s);
        r.clip[i[o][0]] = r.clip[i[o][1]],
        "show" === t.mode && (s.cssClip(r.clip),
        a && a.css(_.effects.clipToBox(r)),
        r.clip = n),
        a && a.animate(_.effects.clipToBox(r), t.duration, t.easing),
        s.animate(r, {
            queue: !1,
            duration: t.duration,
            easing: t.easing,
    ...
    _.effects.define("bounce", function(t, e) {
        var i, s, o = _(this), n = t.mode, r = "hide" === n, a = "show" === n, l = t.direction || "up", c = t.distance, f = t.times || 5, n = 2 * f + (a || r ? 1 : 0), h = t.duration / n, p = t.easing, u = "up" === l || "down" === l ? "top" : "left", d = "up" === l || "left" === l, g = 0, t = o.queue().length;
        for (_.effects.createPlaceholder(o),
        l = o.css(u),
        c = c || o["top" == u ? "outerHeight" : "outerWidth"]() / 3,
        a && ((s = {
            opacity: 1
        })[u] = l,
        o.css("opacity", 0).css(u, d ? 2 * -c : 2 * c).animate(s, h, p)),
        r && (c /= Math.pow(2, f - 1)),
        (s = {})[u] = l; g < f; g++)
            (i = {})[u] = (d ? "-=" : "+=") + c,
            o.animate(i, h, p).animate(s, h, p),
            c = r ? 2 * c : c / 2;
        r && ((i = {
            opacity: 0
        })[u] = (d ? "-=" : "+=") + c,
    ...
    _.effects.define("drop", "hide", function(t, e) {
        ...
        _.effects.createPlaceholder(i),
        o = t.distance || i["top" == n ? "outerHeight" : "outerWidth"](!0) / 2,
        l[n] = r + o,
        s && (i.css(l),
        l[n] = a + o,
        l.opacity = 1),
    ...
    _.effects.define("explode", "hide", function(t, e) {
        var i, s, o, n, r, a, l = t.pieces ? Math.round(Math.sqrt(t.pieces)) : 3, c = l, f = _(this), h = "show" === t.mode, p = f.show().css("visibility", "hidden").offset(), u = Math.ceil(f.outerWidth() / c), d = Math.ceil(f.outerHeight() / l), g = [];
        function m() {
            g.push(this),
            g.length === l * c && (f.css({
                visibility: "visible"
    ...
    _.effects.define("fold", "hide", function(e, t) {
        var i = _(this)
          ...
          , c = e.duration / 2
          , f = _.effects.createPlaceholder(i)
          , h = i.cssClip()
          , p = {
            clip: _.extend({}, h)
        }
          ...
          , d = [h[l[0]], h[l[1]]]
          , s = i.queue().length;
        a && (r = parseInt(a[1], 10) / 100 * d[n ? 0 : 1]),
        p.clip[l[0]] = r,
        u.clip[l[0]] = r,
        u.clip[l[1]] = 0,
        o && (i.cssClip(u.clip),
        f && f.css(_.effects.clipToBox(u)),
        u.clip = h),
        i.queue(function(t) {
            f && f.animate(_.effects.clipToBox(p), c, e.easing).animate(_.effects.clipToBox(u), c, e.easing),
            t()
        }).animate(p, c, e.easing).animate(u, c, e.easing).queue(t),
        _.effects.unshift(i, s, 4)
    }),
    ...
    _.effects.define("size", function(s, e) {
        ...
        "box" !== c && "both" !== c || (o.from.y !== o.to.y && (d = _.effects.setTransition(i, n, o.from.y, d),
        g = _.effects.setTransition(i, n, o.to.y, g)),
        o.from.x !== o.to.x && (d = _.effects.setTransition(i, r, o.from.x, d),
        g = _.effects.setTransition(i, r, o.to.x, g))),
        "content" !== c && "both" !== c || o.from.y !== o.to.y && (d = _.effects.setTransition(i, t, o.from.y, d),
        g = _.effects.setTransition(i, t, o.to.y, g)),
        f && (f = _.effects.getBaseline(f, u),
        d.top = (u.outerHeight - d.outerHeight) * f.y + p.top,
        d.left = (u.outerWidth - d.outerWidth) * f.x + p.left,
        g.top = (u.outerHeight - g.outerHeight) * f.y + p.top,
        g.left = (u.outerWidth - g.outerWidth) * f.x + p.left),
        delete d.outerHeight,
        delete d.outerWidth,
        i.css(d),
        "content" !== c && "both" !== c || (n = n.concat(["marginTop", "marginBottom"]).concat(t),
        r = r.concat(["marginLeft", "marginRight"]),
        i.find("*[width]").each(function() {
            var t = _(this)
              , e = _.effects.scaledDimensions(t)
              , i = {
            ...
            o.from.y !== o.to.y && (i = _.effects.setTransition(t, n, o.from.y, i),
            e = _.effects.setTransition(t, n, o.to.y, e)),
            o.from.x !== o.to.x && (i = _.effects.setTransition(t, r, o.from.x, i),
            e = _.effects.setTransition(t, r, o.to.x, e)),
            l && _.effects.saveStyle(t),
            t.css(i),
        ...
        i.animate(g, {
            ...
            complete: function() {
                var t = i.offset();
                0 === g.opacity && i.css("opacity", d.opacity),
                l || (i.css("position", "static" === h ? "relative" : h).offset(t),
                _.effects.saveStyle(i)),
                e()
            }
        })
    ...
    _.effects.define("scale", function(t, e) {
        var i = _(this)
          ...
          , s = _.extend(!0, {
            ...
            to: _.effects.scaledDimensions(i, s, t.direction || "both"),
            origin: t.origin || ["middle", "center"]
        }, t);
        t.fade && (s.from.opacity = 1,
        s.to.opacity = 0),
        _.effects.effect.size.call(this, s, e)
    }),
    ...
    _.effects.define("shake", function(t, e) {
        var i = 1
          ...
          , u = {}
          , o = s.queue().length;
        for (_.effects.createPlaceholder(s),
        h[c] = (f ? "-=" : "+=") + n,
        p[c] = (f ? "+=" : "-=") + 2 * n,
        u[c] = (f ? "-=" : "+=") + 2 * n,
        s.animate(h, l, t.easing); i < r; i++)
            s.animate(p, l, t.easing).animate(u, l, t.easing);
        s.animate(p, l, t.easing).animate(h, l / 2, t.easing).queue(e),
        _.effects.unshift(s, o, 1 + a)
    }),
    _.effects.define("slide", "show", function(t, e) {
        var i, s, o = _(this), n = {
            ...
            left: ["right", "left"],
            right: ["left", "right"]
        }, r = t.mode, a = t.direction || "left", l = "up" === a || "down" === a ? "top" : "left", c = "up" === a || "left" === a, f = t.distance || o["top" == l ? "outerHeight" : "outerWidth"](!0), h = {};
        _.effects.createPlaceholder(o),
        i = o.cssClip(),
        s = o.position()[l],
        h[l] = (c ? -1 : 1) * f + s,
        h.clip = o.cssClip(),
        h.clip[n[a][1]] = h.clip[n[a][0]],
        "show" === r && (o.cssClip(h.clip),
        o.css(l, h[l]),
        h.clip = i,
        h[l] = s),
        o.animate(h, {
